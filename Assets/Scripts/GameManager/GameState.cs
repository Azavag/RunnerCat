...
public class GameState : AState
{
    ...
    short rerunCounter = 0;
    string metres = string.Empty;
    ...
    public void StartGame()
    {
       ...
       // pauseButton.gameObject.SetActive(!trackManager.isTutorial);
        ...
        m_IsTutorial = !Progress.instance.playerInfo.tutorialDone;
    ...
    protected void UpdateUI()
    {
		...
		distanceText.text = Mathf.FloorToInt(trackManager.worldDistance).ToString() + metres;
    ...
    {
        premiumForLifeButton.interactable = Progress.instance.playerInfo.premium >= 3;

        premiumCurrencyOwned.text = Progress.instance.playerInfo.premium.ToString();
        ClearPowerup();
    ...
    public void PremiumForLife()
    {
        ...
        Progress.instance.playerInfo.premium -= 3;
        //since premium are directly added to the Progress premium count, we also need to remove them from the current run premium count
    ...
    {
        Progress.instance.playerInfo.tutorialDone = true;
        Progress.instance.Save();
