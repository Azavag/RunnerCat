...
/// <summary>
/// Handle everything related to controlling the character. 
/// Interact with both the Character (visual, animation) and CharacterCollider
/// </summary>
public class CharacterInputController : MonoBehaviour
{
	...
	protected void Update ()
    {
		...
		else if ((Input.GetKeyDown(KeyCode.DownArrow) || Input.GetKeyDown(KeyCode.S)) && TutorialMoveCheck(2))
		{
			if(!m_Sliding)
				Slide();
