...
public class MusicPlayer : MonoBehaviour
{
	...
	void Start()
	{
		...
		if (Progress.instance.playerInfo.masterVolume > float.MinValue) 
		{
			mixer.SetFloat ("MasterVolume", Progress.instance.playerInfo.masterVolume);
			mixer.SetFloat ("MusicVolume", Progress.instance.playerInfo.musicVolume);
			mixer.SetFloat ("MasterSFXVolume", Progress.instance.playerInfo.masterSFXVolume);
		}
        else 
		{
			mixer.GetFloat ("MasterVolume", out Progress.instance.playerInfo.masterVolume);
			mixer.GetFloat ("MusicVolume", out Progress.instance.playerInfo.musicVolume);
			mixer.GetFloat ("MasterSFXVolume", out Progress.instance.playerInfo.masterSFXVolume);
