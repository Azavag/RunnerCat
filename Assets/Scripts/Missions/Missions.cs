...
public class SingleRunMission : MissionBase
{
    ...
    {
        if(Language.Instance.currentLanguage.Equals("ru"))
            return "Пробеги " + ((int)max) + "м за один забег";
        else return "Run " + ((int)max) + "m in a single run";
    }
...
public class PickupMission : MissionBase
{
    ...
    {
        if (Language.Instance.currentLanguage.Equals("ru"))
            return "Собери " + max + " косточек";
        else return "Pickup " + max + " fishbones";
    }
...
public class BarrierJumpMission : MissionBase
{
    ...
    {
        if (Language.Instance.currentLanguage.Equals("ru"))
            return "Перепрыгни " + ((int)max) + " барьеров";
        else return "Jump over " + ((int)max) + " barriers";
    }
...
public class SlidingMission : MissionBase
{
    ...
    {
        if (Language.Instance.currentLanguage.Equals("ru"))
            return "Проскользи " + ((int)max) + "м";
        else return "Slide for " + ((int)max) + "m";
    }
...
public class MultiplierMission : MissionBase
{
    ...
    {
        if (Language.Instance.currentLanguage.Equals("ru"))
            return "Достигни x" + ((int)max) + " множителя";
        else return "Reach a x" + ((int)max) + " multiplier";
    }
